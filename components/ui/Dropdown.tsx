  ...
  return (
    <>
      <button
        ...
        className={`flex items-center gap-1.5 py-1 font-mono text-[16px] capitalize transition-opacity ${
              ...
              {options.map((option, index) => {
                ...
                return (
                  <li
                    ...
                    className="flex cursor-pointer items-center justify-between gap-3 rounded-[6px] px-3 py-2 font-mono text-[16px] capitalize"
                    style={{
